...
//	world.ReSizeGLScene(width, height);					// Set Up Our Perspective GL Screen
//
//	if (!world.InitGL())									// Initialize Our Newly Created GL Window
//	{
//		KillGLWindow();								// Reset The Display
...
//	if (!CreateGLWindow("NeHe's First Polygon Tutorial",1024,768,16,fullscreen))
//	{
